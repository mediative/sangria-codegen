object HeroFragmentsApi {
  ...
  object HeroAppearances {
    ...
    case class Hero(name: Option[String], appearsIn: Option[List[Option[Episode]]]) extends HeroFragmentsApi.Appearances
  }
  ...
  object HeroAppearancesAndInlineAlias {
    ...
    case class Hero(name: Option[String], appearsIn: Option[List[Option[Episode]]], heroId: String) extends HeroFragmentsApi.Appearances
  }
  ...
  object HeroFragmentOverlap {
    ...
    case class Hero(id: String, name: Option[String], appearsIn: Option[List[Option[Episode]]]) extends HeroFragmentsApi.Identifiable with HeroFragmentsApi.Appearances
  }
  ...
  object HeroNameAliasAndAppearances {
    ...
    case class Hero(alias: Option[String], name: Option[String], appearsIn: Option[List[Option[Episode]]]) extends HeroFragmentsApi.NameAlias with HeroFragmentsApi.Appearances
  }
  trait Appearances {
